//
// Created by wcmarsha on 9/15/2015.
//

#ifndef CRUISE_FULLKNIGHTBOARD_H
#define CRUISE_FULLKNIGHTBOARD_H

// Forward declared to not take up space.
char board[1024] = {
        '.','.','.','.','.','.','.','.','B','.','.','.','L','L','L','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.',
        '.','.','.','.','.','.','.','.','B','.','.','.','L','L','L','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.',
        '.','.','.','.','.','.','.','.','B','.','.','.','L','L','L','.','.','.','L','L','L','.','.','.','.','.','.','.','.','.','.','.',
...
#endif //CRUISE_FULLKNIGHTBOARD_H
